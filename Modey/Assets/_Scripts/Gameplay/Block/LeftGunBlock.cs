...
{
    public class LeftGunBlock : Block
    {
        public LeftGunBlock( Border border, GameObject prefab, int ColorId, float stepTime)//, Action OnLanded ) 
        ...
        void SetToState0( int rowIndex, int roomIndex )
        {
            ...
            if ( rowIndex + 1 < _border.RowCount                    &&
                 ...
                 _border.IsRoomEmpty( rowIndex + 1, roomIndex + 2 ) )
            {
                // Apply rotation.
                ApplyRotation( 1, 0,
                               rowIndex    , roomIndex + 1,
